 ...
 * '<Root>' : 'helicopter44'
 * '<S1>'   : 'helicopter44/  '
 * '<S2>'   : 'helicopter44/Conversion'
 * '<S3>'   : 'helicopter44/Degrees to Radians'
 * '<S4>'   : 'helicopter44/Elevation controller'
 * '<S5>'   : 'helicopter44/Helicopter_interface'
 * '<S6>'   : 'helicopter44/Pitch controller'
 * '<S7>'   : 'helicopter44/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter44/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter44/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter44/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter44/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter44/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter44/Helicopter_interface/Travel rate  rad to deg'
 */
