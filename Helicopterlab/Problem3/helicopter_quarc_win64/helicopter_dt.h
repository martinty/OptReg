...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter_B.TravelCounttorad), 0, 0, 18 }
  ,
  ...
  { (char_T *)(&helicopter_DW.ToWorkspace_PWORK.LoggedData), 11, 0, 16 },

  { (char_T *)(&helicopter_DW.HILInitialize_ClockModes[0]), 6, 0, 46 },

  { (char_T *)(&helicopter_DW.HILInitialize_POSortedChans[0]), 7, 0, 8 },

  { (char_T *)(&helicopter_DW.FromWorkspace1_IWORK.PrevIndex), 10, 0, 2 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&helicopter_P.K_LQ[0]), 0, 0, 28 },
