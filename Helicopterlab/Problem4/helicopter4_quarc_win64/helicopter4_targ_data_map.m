  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter4_P.u_Value
	  section.data(10).logicalSrcIdx = 84;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter4_P.Gain1_Gain_l
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter4_DW.FromWorkspace2_PWORK.TimePtr
	  ...
	  ;% helicopter4_DW.FromWorkspace2_IWORK.PrevIndex
  ...
  targMap.checksum0 = 3419306624;
  targMap.checksum1 = 2791415762;
  targMap.checksum2 = 3013053323;
  targMap.checksum3 = 2715059400;
