 ...
 */
#ifndef RTW_HEADER_helicopter2_h_
#define RTW_HEADER_helicopter2_h_
#include <math.h>
#include <string.h>
#ifndef helicopter2_COMMON_INCLUDES_
# define helicopter2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter2_COMMON_INCLUDES_ */

#include "helicopter2_types.h"
...
#define helicopter2_rtModel            RT_MODEL_helicopter2_T
...
#define rtB                            helicopter2_B
#define BlockIO                        B_helicopter2_T
#define rtX                            helicopter2_X
#define ContinuousStates               X_helicopter2_T
#define rtXdot                         helicopter2_XDot
#define StateDerivatives               XDot_helicopter2_T
#define tXdis                          helicopter2_XDis
#define StateDisabled                  XDis_helicopter2_T
#define rtP                            helicopter2_P
#define Parameters                     P_helicopter2_T
#define rtDWork                        helicopter2_DW
#define D_Work                         DW_helicopter2_T

/* Parameters (auto storage) */
struct P_helicopter2_T_ {
...
extern P_helicopter2_T helicopter2_P;

/* Block signals (auto storage) */
extern B_helicopter2_T helicopter2_B;

/* Continuous states (auto storage) */
extern X_helicopter2_T helicopter2_X;

/* Block states (auto storage) */
extern DW_helicopter2_T helicopter2_DW;

/* Model entry point functions */
extern void helicopter2_initialize(void);
extern void helicopter2_output(void);
extern void helicopter2_update(void);
extern void helicopter2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter2_T *const helicopter2_M;
 ...
 *
 * '<Root>' : 'helicopter2'
 * '<S1>'   : 'helicopter2/Conversion'
 * '<S2>'   : 'helicopter2/Degrees to Radians'
 * '<S3>'   : 'helicopter2/Degrees to Radians1'
 * '<S4>'   : 'helicopter2/Degrees to Radians3'
 * '<S5>'   : 'helicopter2/Elevation controller'
 * '<S6>'   : 'helicopter2/Helicopter_interface'
 * '<S7>'   : 'helicopter2/Pitch controller'
 * '<S8>'   : 'helicopter2/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter2/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter2/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter2/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter2/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter2_h_ */
